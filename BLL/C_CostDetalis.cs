...
namespace yny_005.BLL
{
	...
	{
		private readonly yny_005.DAL.C_CostDetalis dal=new yny_005.DAL.C_CostDetalis();
		...
		/// 获得数据列表
		/// </summary>
		public static List<yny_005.Model.C_CostDetalis> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public static List<yny_005.Model.C_CostDetalis> DataTableToList(DataTable dt)
		{
			List<yny_005.Model.C_CostDetalis> modelList = new List<yny_005.Model.C_CostDetalis>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				yny_005.Model.C_CostDetalis model;
