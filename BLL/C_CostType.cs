...
namespace yny_005.BLL
{
	...
	{
		private readonly yny_005.DAL.C_CostType dal=new yny_005.DAL.C_CostType();
		public  C_CostType()
		{}
		#region  BasicMethod
		...
		/// 获得数据列表
		/// </summary>
		public static List<yny_005.Model.C_CostType> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public static List<yny_005.Model.C_CostType> DataTableToList(DataTable dt)
		{
			List<yny_005.Model.C_CostType> modelList = new List<yny_005.Model.C_CostType>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				yny_005.Model.C_CostType model;
