...
namespace yny_005.BLL
{
	...
	public partial class AccountDetails
	{
        ...
        /// 获得数据列表
        /// </summary>
        public static List<yny_005.Model.AccountDetails> GetModelList(string strWhere)
		{
        ...
        /// 获得数据列表
        /// </summary>
        public static List<yny_005.Model.AccountDetails> DataTableToList(DataTable dt)
		{
			List<yny_005.Model.AccountDetails> modelList = new List<yny_005.Model.AccountDetails>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				yny_005.Model.AccountDetails model;
