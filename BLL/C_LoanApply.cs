...
namespace yny_005.BLL
{
	...
	{
		private readonly yny_005.DAL.C_LoanApply dal=new yny_005.DAL.C_LoanApply();
		public  C_LoanApply()
		{}
		#region  BasicMethod
		...
		/// 获得数据列表
		/// </summary>
		public static List<yny_005.Model.C_LoanApply> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public static List<yny_005.Model.C_LoanApply> DataTableToList(DataTable dt)
		{
			List<yny_005.Model.C_LoanApply> modelList = new List<yny_005.Model.C_LoanApply>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				yny_005.Model.C_LoanApply model;
