...
namespace yny_005.BLL
{
    ...
    {
        private readonly yny_005.DAL.ImpType dal = new yny_005.DAL.ImpType();
        public ImpType()
        { }
        #region  BasicMethod
        /// <summary>
        /// 增加一条数据
        /// </summary>
        public static bool Add(yny_005.Model.ImpType model)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public static bool Update(yny_005.Model.ImpType model)
        {
        ...
        /// 得到一个对象实体
        /// </summary>
        public static yny_005.Model.ImpType GetModel(int ID)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public static List<yny_005.Model.ImpType> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public static List<yny_005.Model.ImpType> DataTableToList(DataTable dt)
        {
            List<yny_005.Model.ImpType> modelList = new List<yny_005.Model.ImpType>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                yny_005.Model.ImpType model;
