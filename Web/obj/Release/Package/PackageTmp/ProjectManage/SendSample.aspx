<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SendSample.aspx.cs" Inherits="yny_005.Web.ProjectManage.SendSample" %>
        ...
        <div id="finance">
            <form id="form1">
                ...
                <table cellpadding="0" cellspacing="0">
                   ...
                   <tr>
                        <td width="15%" align="right">物流名称
                        </td>
                        <td width="75%" style="height: 40px;"> <input id="Text4" class="normal_input" value="" runat="server" style="width: 20%;" />

                        </td>
                    </tr>
                     <tr>
                        <td width="15%" align="right">单号
                        </td>
                        <td width="75%" style="height: 40px;"><input id="Text1" class="normal_input" value="" runat="server" style="width: 20%;" />
                        </td>
                    </tr>
                    <tr>
                        <td width="15%" align="right"></td>
                        <td width="75%" align="left">
                            <input type="button" class="normal_btnok" value="我要邮寄样品" onclick="checkChange();" />
                        </td>
                    </tr>
