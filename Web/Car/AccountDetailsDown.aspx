<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AccountDetailsDown.aspx.cs" Inherits="yny_005.Web.Car.AccountDetailsDown" %>
...
<body>
        ...
        <div id="finance">
            <form id="form1">
                ...
                <table cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="15%" align="right">收款单编号<input runat="server" id="lbID" type="hidden" />
                        </td>
                    ...
                    <tr>
                     ...
                     <tr>
                        <td width="15%" align="right">客户账户余额
                        </td>
                        <td width="75%" style="height: 40px;">
    ...
    <script type="text/javascript">
        ...
        function checkChange() {
            if ($('#PayMoney').val() == '') {
                v5.error('收款金额不能为空', '1', 'ture');
            } else {
                ActionModel("Car/AccountDetailsDown.aspx?Action=Modify", $('#form1').serialize());
            }
        }
    </script>
</body>
