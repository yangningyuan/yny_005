<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ModifySignProject.aspx.cs" Inherits="yny_005.Web.ProjectManage.ModifySignProject" %>
    ...
    <div id="mempay">
        <div id="finance">
            <form id="form1">
                ...
                <input type="hidden" id="bmid" runat="server" />
                ...
                <table cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <img id="DataImg" src="<%=oua.BaoMingImgUrl %>" style="width: 100px; height: 100px;" />
                            <input type="hidden" id="uploadurl" value="" name="uploadurl" runat="server" />
                            <input runat="server" id="roam" style="display: none;" />
                             文件类型约束为：jpg，jpeg，png，gif，bmp 大小不超过多少600K
                        </td>
                    </tr>
                    <tr>
                        <td align="right">上传报名交费凭证:
                        </td>
                        <td>
                            ...
                            <img id="DataImg2" src="<%=oua.FeiYongImgUrl %>" style="width: 100px; height: 100px;" />
                            <input type="hidden" id="uploadurl2" value="" name="uploadurl2" runat="server" />
    ...
    <script>
        function checkChange() {
            ...
            if (check_val == "") {
                ...
                ActionModel("ProjectManage/ModifySignProject.aspx?Action=Add", $('#form1').serialize());
            }
        }
    </script>
</body>
