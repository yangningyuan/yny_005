<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MSampleList.aspx.cs" Inherits="yny_005.Web.ProjectManage.MSampleList" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        tUrl = "ProjectManage/Handler/MSampleList.ashx";
        tState = "";
        SearchByCondition();
        //        setup();
