...
namespace yny_005.Web.ProjectManage.Handler
{
    ...
    /// SampleList 的摘要说明
    /// </summary>
    public class SampleList : BaseHandler
    {
        ...
        public override void ProcessRequest(HttpContext context)
        {
            ...
            for (int i = 0; i < ListO.Count; i++)
            {
                ...
                sb.Append((ListO[i].SState==1? "<div  class=\"pay btn btn-success\" onclick=\"callhtml('/ProjectManage/SampleCom.aspx?xxid=" + ListO[i].ID + "','样品确认')\">样品确认</ div > " : ""));
                sb.Append("≌");
            }
