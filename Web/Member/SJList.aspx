<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SJList.aspx.cs" Inherits="zx270.Web.Member.SJList" %>
        ...
        <div class="control">
            <div class="select">
                <a href="javascript:void(0);" onclick="SearchByState('false',this);" class="btn btn-danger">
                    未激活</a><a href="javascript:void(0)" onclick="SearchByState('true',this);" class="btn btn-success">已激活</a></div>
