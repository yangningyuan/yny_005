<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TJList.aspx.cs" Inherits="yny_005.Web.mobile.html.TJList" %>
...
<div class="content content-padded pull-to-refresh-content" data-ptr-distance="55">
    ...
    <table class=" table table-striped table-bordered ">
        <thead>
            <tr>
                <th>员工账号</th>
                <th><%=yny_005.BLL.Reward.List["MHB"].RewardName %></th>
                <th><%=yny_005.BLL.Reward.List["MJB"].RewardName %></th>
                <th>注册/激活时间</th>
            </tr>
        </thead>
