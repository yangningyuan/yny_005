<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cars.aspx.cs" Inherits="yny_005.Web.mobile.html.Cars" %>
        ...
        <form id="form1">
            ...
            <section id="main">
                <%--  <div class="buy_handle finish_edit">
                    ...
                    <%
                        foreach (yny_005.Model.ShopCar item in listshop)
                        {
                            yny_005.Model.Goods goods = yny_005.BLL.Goods.GetModel(item.GId);
                    %>
                    <div class="media">
                ...
                <div class="buy_handle edit_goods">
                    ...
                    <div class="media">
                        <a class="pull-left" href="#">
                            ...
                            <%if (yny_005.BLL.GoodsPic.GetList("IsDeleted=0 and GId='" + goods.GoodsCode + "'").FirstOrDefault() == null)
                                {%>
                            ...
                            <% }
                                ...
                                {%>
                            <img class="media-object produce" src="<%= yny_005.BLL.GoodsPic.GetList("IsDeleted=0 and GId='" + goods.GoodsCode + "'").FirstOrDefault().PicURL %>" alt="<%=goods.GName %>">
