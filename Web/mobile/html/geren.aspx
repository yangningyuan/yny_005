<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="geren.aspx.cs" Inherits="yny_005.Web.mobile.html.geren" %>
                        ...
                        <div class="row">
                            ...
                            <div class="col-70">
                                <ul class="personlist">
                                   ...
                                   <%-- <li><i class="jiangjin"></i><%=yny_005.BLL.Reward.List["MHB"].RewardName %>：<%=TModel.MConfig.MHB %></li>
                                    <li><i class="currentm"></i><%=yny_005.BLL.Reward.List["MJB"].RewardName %>：<%=TModel.MConfig.MJB %></li>--%>
