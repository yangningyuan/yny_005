<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PayOrder.aspx.cs" Inherits="yny_005.Web.mobile.html.PayOrder" %>
<style>
    #rdoMJB,#rdoXFB{
        width:5%;
        line-height:14px;
        ...
        <div class="content">
          ...
          <input id="hdBankCode" type="hidden" runat="server" />
            ...
            <div class="zc_in">
                ...
                <input id="rdoXFB" value="MHB" type="radio" name="rdo"/><label for="wx"><%=yny_005.BLL.Reward.List["MHB"].RewardName%></label>
            </div>
            <div class="zc_in">
                <span>币种余额：</span>
              我的<%=yny_005.BLL.Reward.List["MHB"].RewardName %>：<%=TModel.MConfig.MHB%>
            </div>
