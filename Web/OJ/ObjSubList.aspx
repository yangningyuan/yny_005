<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ObjSubList.aspx.cs" Inherits="yny_005.Web.OJ.ObjSubList" %>
    ...
    <div id="mempay">
        <div class="control">
            ...
            <div class="select">
                ...
                <span style="color: azure;">经费来源：<%=yny_005.BLL.FundType.GetModel(obj.FundID).Name %></span><br />
                <span style="color: azure;">批复文号：<%=obj.TheNumID %></span><br />
                <span style="color: azure;">批复部门：<%=yny_005.BLL.DepartType.GetModel(obj.DepartID).Name %></span><br />
